 ...
 * Service version: 0.4.4-add-currencies-to-payment-methods
 * apibuilder:0.12.61 https://app.apibuilder.io/flow/reference/0.4.4-add-currencies-to-payment-methods/scala_models
 */
package io.flow.reference.v0.models {
   ...
   * @param supportedCurrencies A list of the currencies supported by this payment_method.  This field is
   *        optional.  Omitting it implies that all currencies are supported.  Providing an
   *        empty list implies that *NO* currencies are supported
   */
  case class PaymentMethod(
    ...
    regions: Seq[String],
    supportedCurrencies: _root_.scala.Option[Seq[io.flow.reference.v0.models.Currency]] = None
  )
