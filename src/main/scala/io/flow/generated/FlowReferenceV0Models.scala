 ...
 * apibuilder:0.12.38 https://app.apibuilder.io/flow/reference/0.3.30/scala_models
 */
package io.flow.reference.v0.models {
   ...
   * @param defaultDeliveredDuty Default delivered duty value. See
   * https://en.wikipedia.org/wiki/Incoterms for more information
   * @param name
   * @param iso31662 ISO 3166 2-character country code. See
   * https://api.flow.io/reference/countries
   * @param iso31663 ISO 3166 3-character country code. See
   * https://api.flow.io/reference/countries
   * @param languages A list of the languages spoken in this country
   * @param measurementSystem
   * @param defaultCurrency ISO 4217 3-character currency code. See
   ...
   * @param name
   * @param numberDecimals The number of decimal places used by the given currency.
   * For example, USD has 2 decimals while JPY has 0.
   * @param symbols
   * @param defaultLocale The locale id of the default locale to use when rendering
   * this currency
   * @param iso42173
   */
  case class Currency(
   ...
   * @param id
   * @param languages A list of the languages as ISO 639 2 codes spoken in this
   * region
   * @param measurementSystems A list of the measurement systems in use in this
   * region (metric or imperial)
