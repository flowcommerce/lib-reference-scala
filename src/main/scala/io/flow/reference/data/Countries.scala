...
object Countries {
  ...
  val Afg: Country = Country(
    iso31662 = "AF",
    iso31663 = "AFG",
    defaultCurrency = Some("EUR"),
    defaultLanguage = Some("ps"),
  ...
  val Alb: Country = Country(
    iso31662 = "AL",
    iso31663 = "ALB",
    defaultCurrency = Some("ALL"),
    defaultLanguage = Some("sq"),
    measurementSystem = "metric",
    name = "Albania",
    languages = Seq("sq"),
    timezones = Nil
  ...
  val Dza: Country = Country(
    iso31662 = "DZ",
    iso31663 = "DZA",
    defaultCurrency = Some("DZD"),
    defaultLanguage = Some("ar"),
    measurementSystem = "metric",
    name = "Algeria",
    languages = Seq("ar"),
    timezones = Nil
  ...
  val Ago: Country = Country(
    iso31662 = "AO",
    iso31663 = "AGO",
    defaultCurrency = Some("AOA"),
    defaultLanguage = Some("kg"),
    measurementSystem = "metric",
    name = "Angola",
  ...
  val Arg: Country = Country(
    iso31662 = "AR",
    iso31663 = "ARG",
    defaultCurrency = Some("ARS"),
    defaultLanguage = Some("es"),
    measurementSystem = "metric",
    name = "Argentina",
    languages = Seq("es"),
    timezones = Nil
  ...
  val Arm: Country = Country(
    iso31662 = "AM",
    iso31663 = "ARM",
    defaultCurrency = Some("AMD"),
    defaultLanguage = Some("hy"),
    measurementSystem = "metric",
    name = "Armenia",
    languages = Seq("hy"),
    timezones = Nil
  ...
  val Abw: Country = Country(
    iso31662 = "AW",
    iso31663 = "ABW",
    defaultCurrency = Some("AWG"),
    defaultLanguage = Some("nl"),
    measurementSystem = "metric",
    name = "Aruba",
    languages = Seq("nl"),
    timezones = Nil
  ...
  val Aze: Country = Country(
    iso31662 = "AZ",
    iso31663 = "AZE",
    defaultCurrency = Some("AZN"),
    defaultLanguage = Some("az"),
    measurementSystem = "metric",
    name = "Azerbaijan",
    languages = Seq("az"),
    timezones = Nil
  ...
  val Bgd: Country = Country(
    iso31662 = "BD",
    iso31663 = "BGD",
    defaultCurrency = Some("BDT"),
    defaultLanguage = Some("bn"),
    measurementSystem = "metric",
    name = "Bangladesh",
    languages = Seq("bn"),
    timezones = Nil
  ...
  val Blr: Country = Country(
    iso31662 = "BY",
    iso31663 = "BLR",
    defaultCurrency = Some("BYN"),
    defaultLanguage = Some("be"),
    measurementSystem = "metric",
    name = "Belarus",
    languages = Seq("be", "ru"),
    timezones = Nil
  ...
  val Bih: Country = Country(
    iso31662 = "BA",
    iso31663 = "BIH",
    defaultCurrency = Some("BAM"),
    defaultLanguage = Some("bs"),
    measurementSystem = "metric",
  ...
  val Brn: Country = Country(
    iso31662 = "BN",
    iso31663 = "BRN",
    defaultCurrency = Some("BND"),
    defaultLanguage = Some("ms"),
    measurementSystem = "metric",
  ...
  val Khm: Country = Country(
    iso31662 = "KH",
    iso31663 = "KHM",
    defaultCurrency = Some("KHR"),
    defaultLanguage = Some("km"),
    measurementSystem = "metric",
    name = "Cambodia",
    languages = Seq("km"),
    timezones = Nil
  ...
  val Chn: Country = Country(
    iso31662 = "CN",
    iso31663 = "CHN",
    defaultCurrency = Some("CNY"),
    defaultLanguage = Some("zh"),
    measurementSystem = "metric",
    name = "China",
    languages = Seq("zh"),
  ...
  val Cze: Country = Country(
    iso31662 = "CZ",
    iso31663 = "CZE",
    defaultCurrency = Some("CZK"),
    defaultLanguage = Some("cs"),
    measurementSystem = "metric",
    name = "Czechia",
    languages = Seq("cs", "sk"),
    timezones = Nil
  ...
  val Dnk: Country = Country(
    iso31662 = "DK",
    iso31663 = "DNK",
    defaultCurrency = Some("DKK"),
    defaultLanguage = Some("da"),
    measurementSystem = "metric",
    name = "Denmark",
    languages = Seq("da"),
    timezones = Nil
  ...
  val Dji: Country = Country(
    iso31662 = "DJ",
    iso31663 = "DJI",
    defaultCurrency = Some("DJF"),
    defaultLanguage = Some("aa"),
    measurementSystem = "metric",
    name = "Djibouti",
  ...
  val Eth: Country = Country(
    iso31662 = "ET",
    iso31663 = "ETH",
    defaultCurrency = Some("ETB"),
    defaultLanguage = Some("am"),
    measurementSystem = "metric",
    name = "Ethiopia",
    languages = Seq("am"),
    timezones = Nil
  ...
  val Geo: Country = Country(
    iso31662 = "GE",
    iso31663 = "GEO",
    defaultCurrency = Some("GEL"),
    defaultLanguage = Some("ka"),
    measurementSystem = "metric",
    name = "Georgia",
    languages = Seq("ka"),
    timezones = Nil
  ...
  val Gha: Country = Country(
    iso31662 = "GH",
    iso31663 = "GHA",
    defaultCurrency = Some("GHS"),
    defaultLanguage = Some("ak"),
    measurementSystem = "metric",
    name = "Ghana",
  ...
  val Hun: Country = Country(
    iso31662 = "HU",
    iso31663 = "HUN",
    defaultCurrency = Some("HUF"),
    defaultLanguage = Some("hu"),
    measurementSystem = "metric",
    name = "Hungary",
    languages = Seq("hu"),
    timezones = Nil
  ...
  val Isl: Country = Country(
    iso31662 = "IS",
    iso31663 = "ISL",
    defaultCurrency = Some("ISK"),
    defaultLanguage = Some("is"),
    measurementSystem = "metric",
    name = "Iceland",
    languages = Seq("is"),
    timezones = Nil
  ...
  val Idn: Country = Country(
    iso31662 = "ID",
    iso31663 = "IDN",
    defaultCurrency = Some("IDR"),
    defaultLanguage = Some("id"),
    measurementSystem = "metric",
    name = "Indonesia",
    languages = Seq("id", "ms"),
    timezones = Nil
  ...
  val Jpn: Country = Country(
    iso31662 = "JP",
    iso31663 = "JPN",
    defaultCurrency = Some("JPY"),
    defaultLanguage = Some("ja"),
    measurementSystem = "metric",
    name = "Japan",
    languages = Seq("ja"),
    timezones = Nil
  ...
  val Kaz: Country = Country(
    iso31662 = "KZ",
    iso31663 = "KAZ",
    defaultCurrency = Some("KZT"),
    defaultLanguage = Some("kk"),
    measurementSystem = "metric",
    name = "Kazakhstan",
    languages = Seq("kk", "ru"),
    timezones = Nil
  ...
  val Kgz: Country = Country(
    iso31662 = "KG",
    iso31663 = "KGZ",
    defaultCurrency = Some("KGS"),
    defaultLanguage = Some("ky"),
    measurementSystem = "metric",
    name = "Kyrgyzstan",
    languages = Seq("ky", "ru"),
    timezones = Nil
  ...
  val Lao: Country = Country(
    iso31662 = "LA",
    iso31663 = "LAO",
    defaultCurrency = Some("LAK"),
    defaultLanguage = Some("lo"),
    measurementSystem = "metric",
  ...
  val Mwi: Country = Country(
    iso31662 = "MW",
    iso31663 = "MWI",
    defaultCurrency = Some("MWK"),
    defaultLanguage = Some("ny"),
    measurementSystem = "metric",
    name = "Malawi",
    languages = Seq("en", "ny"),
    timezones = Nil
  ...
  val Mdv: Country = Country(
    iso31662 = "MV",
    iso31663 = "MDV",
    defaultCurrency = Some("MVR"),
    defaultLanguage = Some("dv"),
    measurementSystem = "metric",
    name = "Maldives",
    languages = Seq("dv"),
    timezones = Nil
  ...
  val Mng: Country = Country(
    iso31662 = "MN",
    iso31663 = "MNG",
    defaultCurrency = Some("MNT"),
    defaultLanguage = Some("mn"),
    measurementSystem = "metric",
    name = "Mongolia",
    languages = Seq("mn"),
    timezones = Nil
  ...
  val Mmr: Country = Country(
    iso31662 = "MM",
    iso31663 = "MMR",
    defaultCurrency = Some("MMK"),
    defaultLanguage = Some("my"),
    measurementSystem = "imperial",
    name = "Myanmar",
    languages = Seq("my"),
    timezones = Nil
  ...
  val Npl: Country = Country(
    iso31662 = "NP",
    iso31663 = "NPL",
    defaultCurrency = Some("NPR"),
    defaultLanguage = Some("ne"),
    measurementSystem = "metric",
    name = "Nepal",
    languages = Seq("ne"),
    timezones = Nil
  ...
  val Pol: Country = Country(
    iso31662 = "PL",
    iso31663 = "POL",
    defaultCurrency = Some("PLN"),
    defaultLanguage = Some("pl"),
    measurementSystem = "metric",
    name = "Poland",
    languages = Seq("pl"),
    timezones = Nil
  ...
  val Mda: Country = Country(
    iso31662 = "MD",
    iso31663 = "MDA",
    defaultCurrency = Some("MDL"),
    defaultLanguage = Some("ro"),
    measurementSystem = "metric",
  ...
  val Rus: Country = Country(
    iso31662 = "RU",
    iso31663 = "RUS",
    defaultCurrency = Some("RUB"),
    defaultLanguage = Some("ru"),
    measurementSystem = "metric",
  ...
  val Srb: Country = Country(
    iso31662 = "RS",
    iso31663 = "SRB",
    defaultCurrency = Some("RSD"),
    defaultLanguage = Some("sr"),
    measurementSystem = "metric",
    name = "Serbia",
    languages = Seq("sr"),
    timezones = Nil
  ...
  val Swe: Country = Country(
    iso31662 = "SE",
    iso31663 = "SWE",
    defaultCurrency = Some("SEK"),
    defaultLanguage = Some("sv"),
    measurementSystem = "metric",
    name = "Sweden",
    languages = Seq("sv"),
    timezones = Nil
  ...
  val Tha: Country = Country(
    iso31662 = "TH",
    iso31663 = "THA",
    defaultCurrency = Some("THB"),
    defaultLanguage = Some("th"),
    measurementSystem = "metric",
    name = "Thailand",
    languages = Seq("th"),
    timezones = Nil
  ...
  val Tur: Country = Country(
    iso31662 = "TR",
    iso31663 = "TUR",
    defaultCurrency = Some("TRY"),
    defaultLanguage = Some("tr"),
    measurementSystem = "metric",
    name = "Turkey",
    languages = Seq("tr"),
    timezones = Nil
  ...
  val Ukr: Country = Country(
    iso31662 = "UA",
    iso31663 = "UKR",
    defaultCurrency = Some("UAH"),
    defaultLanguage = Some("uk"),
    measurementSystem = "metric",
    name = "Ukraine",
    languages = Seq("uk"),
    timezones = Nil
  ...
  val Uzb: Country = Country(
    iso31662 = "UZ",
    iso31663 = "UZB",
    defaultCurrency = Some("UZS"),
    defaultLanguage = Some("uz"),
    measurementSystem = "metric",
    name = "Uzbekistan",
    languages = Seq("uz"),
    timezones = Nil
  ...
  val Vut: Country = Country(
    iso31662 = "VU",
    iso31663 = "VUT",
    defaultCurrency = Some("VUV"),
    defaultLanguage = Some("bi"),
    measurementSystem = "metric",
    name = "Vanuatu",
  ...
  val Vnm: Country = Country(
    iso31662 = "VN",
    iso31663 = "VNM",
    defaultCurrency = Some("VND"),
    defaultLanguage = Some("vi"),
    measurementSystem = "metric",
    name = "Vietnam",
    languages = Seq("vi"),
    timezones = Nil
