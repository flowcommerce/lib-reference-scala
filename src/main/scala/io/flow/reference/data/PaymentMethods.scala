...
object PaymentMethods {
  ...
  val Ach: PaymentMethod = PaymentMethod(id = "ach", `type` = PaymentMethodType.Online, name = "ACH", images = PaymentMethodImages(
  ...
  val Afterpay: PaymentMethod = PaymentMethod(id = "afterpay", `type` = PaymentMethodType.Online, name = "Afterpay", images = PaymentMethodImages(
  ...
  val Alipay: PaymentMethod = PaymentMethod(id = "alipay", `type` = PaymentMethodType.Online, name = "Alipay", images = PaymentMethodImages(
  ...
  val AmericanExpress: PaymentMethod = PaymentMethod(id = "american_express", `type` = PaymentMethodType.Card, name = "American Express", images = PaymentMethodImages(
                                    ...
                                    ), regions = Seq("world"), capabilities = Some(Seq(PaymentMethodCapability.Credit)))
  val ApplePay: PaymentMethod = PaymentMethod(id = "apple_pay", `type` = PaymentMethodType.Online, name = "Apple Pay", images = PaymentMethodImages(
  ...
  val Bitcoin: PaymentMethod = PaymentMethod(id = "bitcoin", `type` = PaymentMethodType.Online, name = "Bitcoin", images = PaymentMethodImages(
  ...
  val Bitpay: PaymentMethod = PaymentMethod(id = "bitpay", `type` = PaymentMethodType.Online, name = "BitPay", images = PaymentMethodImages(
  ...
  val CartesBancaires: PaymentMethod = PaymentMethod(id = "cartes_bancaires", `type` = PaymentMethodType.Card, name = "Cartes Bancaires", images = PaymentMethodImages(
  ...
  val CashOnDelivery: PaymentMethod = PaymentMethod(id = "cash_on_delivery", `type` = PaymentMethodType.Online, name = "Cash on Delivery", images = PaymentMethodImages(
  ...
  val ChinaUnionPay: PaymentMethod = PaymentMethod(id = "china_union_pay", `type` = PaymentMethodType.Card, name = "China Union Pay", images = PaymentMethodImages(
                                    ...
                                    ), regions = Seq("chn"), capabilities = Some(Seq(PaymentMethodCapability.Credit, PaymentMethodCapability.Debit)))
  val CryptocomPay: PaymentMethod = PaymentMethod(id = "cryptocom_pay", `type` = PaymentMethodType.Online, name = "Crypto.com Pay", images = PaymentMethodImages(
                                      small = PaymentMethodImage(url = "https://flowcdn.io/util/logos/payment-methods/cryptocom_pay/30/original.png", width = 65, height = 41),
                                      medium = PaymentMethodImage(url = "https://flowcdn.io/util/logos/payment-methods/cryptocom_pay/60/original.png", width = 100, height = 60),
                                      large = PaymentMethodImage(url = "https://flowcdn.io/util/logos/payment-methods/cryptocom_pay/120/original.png", width = 256, height = 256)
                                    ), regions = Seq("world"), capabilities = Some(Nil))
  val Dankort: PaymentMethod = PaymentMethod(id = "dankort", `type` = PaymentMethodType.Card, name = "Dankort", images = PaymentMethodImages(
                                    ...
                                    ), regions = Seq("europe"), capabilities = Some(Seq(PaymentMethodCapability.Debit)))
  val DinersClub: PaymentMethod = PaymentMethod(id = "diners_club", `type` = PaymentMethodType.Card, name = "Diners Club", images = PaymentMethodImages(
                                    ...
                                    ), regions = Seq("europe", "north-america"), capabilities = Some(Seq(PaymentMethodCapability.Credit)))
  val Directebanking: PaymentMethod = PaymentMethod(id = "directEbanking", `type` = PaymentMethodType.Online, name = "Sofortüberweisung", images = PaymentMethodImages(
  ...
  val Discover: PaymentMethod = PaymentMethod(id = "discover", `type` = PaymentMethodType.Card, name = "Discover", images = PaymentMethodImages(
  ...
  val Dotpay: PaymentMethod = PaymentMethod(id = "dotpay", `type` = PaymentMethodType.Online, name = "Dotpay", images = PaymentMethodImages(
  ...
  val DragonpayEbanking: PaymentMethod = PaymentMethod(id = "dragonpay_ebanking", `type` = PaymentMethodType.Online, name = "Dragonpay eBanking", images = PaymentMethodImages(
  ...
  val DragonpayGcash: PaymentMethod = PaymentMethod(id = "dragonpay_gcash", `type` = PaymentMethodType.Online, name = "GCash via Dragonpay", images = PaymentMethodImages(
  ...
  val DragonpayOtcBanking: PaymentMethod = PaymentMethod(id = "dragonpay_otc_banking", `type` = PaymentMethodType.Online, name = "Dragonpay OTC", images = PaymentMethodImages(
  ...
  val EbankingFi: PaymentMethod = PaymentMethod(id = "ebanking_FI", `type` = PaymentMethodType.Online, name = "Finnish E-Banking", images = PaymentMethodImages(
  ...
  val Giropay: PaymentMethod = PaymentMethod(id = "giropay", `type` = PaymentMethodType.Online, name = "GiroPay", images = PaymentMethodImages(
  ...
  val GooglePay: PaymentMethod = PaymentMethod(id = "google_pay", `type` = PaymentMethodType.Online, name = "Google Pay", images = PaymentMethodImages(
  ...
  val Grabpay: PaymentMethod = PaymentMethod(id = "grabpay", `type` = PaymentMethodType.Online, name = "GrabPay", images = PaymentMethodImages(
                                      small = PaymentMethodImage(url = "https://flowcdn.io/util/logos/payment-methods/grabpay/30/original.png", width = 40, height = 26),
                                      medium = PaymentMethodImage(url = "https://flowcdn.io/util/logos/payment-methods/grabpay/60/original.png", width = 77, height = 50),
                                      large = PaymentMethodImage(url = "https://flowcdn.io/util/logos/payment-methods/grabpay/120/original.png", width = 154, height = 100)
                                    ), regions = Seq("world"), capabilities = Some(Nil))
  val Ideal: PaymentMethod = PaymentMethod(id = "ideal", `type` = PaymentMethodType.Online, name = "iDEAL", images = PaymentMethodImages(
  ...
  val Interac: PaymentMethod = PaymentMethod(id = "interac", `type` = PaymentMethodType.Online, name = "Interac Online", images = PaymentMethodImages(
  ...
  val Jcb: PaymentMethod = PaymentMethod(id = "jcb", `type` = PaymentMethodType.Card, name = "Jcb", images = PaymentMethodImages(
                                    ...
                                    ), regions = Seq("jpn"), capabilities = Some(Seq(PaymentMethodCapability.Credit, PaymentMethodCapability.Debit)))
  val KcpBanktransfer: PaymentMethod = PaymentMethod(id = "kcp_banktransfer", `type` = PaymentMethodType.Online, name = "Bank Transfer via KCP", images = PaymentMethodImages(
  ...
  val KcpCreditcard: PaymentMethod = PaymentMethod(id = "kcp_creditcard", `type` = PaymentMethodType.Online, name = "Credit Card via KCP", images = PaymentMethodImages(
  ...
  val KcpPayco: PaymentMethod = PaymentMethod(id = "kcp_payco", `type` = PaymentMethodType.Online, name = "PayCo", images = PaymentMethodImages(
  ...
  val Klarna: PaymentMethod = PaymentMethod(id = "klarna", `type` = PaymentMethodType.Online, name = "Klarna", images = PaymentMethodImages(
  ...
  val Maestro: PaymentMethod = PaymentMethod(id = "maestro", `type` = PaymentMethodType.Card, name = "Maestro", images = PaymentMethodImages(
  ...
  val Mastercard: PaymentMethod = PaymentMethod(id = "mastercard", `type` = PaymentMethodType.Card, name = "Mastercard", images = PaymentMethodImages(
  ...
  val Mobilepay: PaymentMethod = PaymentMethod(id = "mobilepay", `type` = PaymentMethodType.Online, name = "MobilePay", images = PaymentMethodImages(
                                      small = PaymentMethodImage(url = "https://flowcdn.io/util/logos/payment-methods/mobilepay/30/original.png", width = 65, height = 41),
                                      medium = PaymentMethodImage(url = "https://flowcdn.io/util/logos/payment-methods/mobilepay/60/original.png", width = 100, height = 60),
                                      large = PaymentMethodImage(url = "https://flowcdn.io/util/logos/payment-methods/mobilepay/120/original.png", width = 256, height = 256)
                                    ), regions = Seq("world"), capabilities = Some(Nil))
  val MolpayPoints: PaymentMethod = PaymentMethod(id = "molpay_points", `type` = PaymentMethodType.Online, name = "MOLPoints via MOLPay", images = PaymentMethodImages(
  ...
  val Multibanco: PaymentMethod = PaymentMethod(id = "multibanco", `type` = PaymentMethodType.Online, name = "Multibanco", images = PaymentMethodImages(
  ...
  val Paypal: PaymentMethod = PaymentMethod(id = "paypal", `type` = PaymentMethodType.Online, name = "PayPal", images = PaymentMethodImages(
  ...
  val Przelewy24: PaymentMethod = PaymentMethod(id = "przelewy24", `type` = PaymentMethodType.Online, name = "Przelewy24", images = PaymentMethodImages(
                                      small = PaymentMethodImage(url = "https://flowcdn.io/util/logos/payment-methods/przelewy24/30/original.png", width = 65, height = 41),
                                      medium = PaymentMethodImage(url = "https://flowcdn.io/util/logos/payment-methods/przelewy24/60/original.png", width = 100, height = 60),
                                      large = PaymentMethodImage(url = "https://flowcdn.io/util/logos/payment-methods/przelewy24/120/original.png", width = 256, height = 256)
                                    ), regions = Seq("world"), capabilities = Some(Nil))
  val Qiwiwallet: PaymentMethod = PaymentMethod(id = "qiwiwallet", `type` = PaymentMethodType.Online, name = "Qiwi Wallet", images = PaymentMethodImages(
  ...
  val Sepadirectdebit: PaymentMethod = PaymentMethod(id = "sepadirectdebit", `type` = PaymentMethodType.Online, name = "SEPA Direct Debit", images = PaymentMethodImages(
  ...
  val Trustly: PaymentMethod = PaymentMethod(id = "trustly", `type` = PaymentMethodType.Online, name = "Trustly", images = PaymentMethodImages(
  ...
  val Trustpay: PaymentMethod = PaymentMethod(id = "trustpay", `type` = PaymentMethodType.Online, name = "TrustPay", images = PaymentMethodImages(
  ...
  val Twint: PaymentMethod = PaymentMethod(id = "twint", `type` = PaymentMethodType.Online, name = "Twint", images = PaymentMethodImages(
                                      small = PaymentMethodImage(url = "https://flowcdn.io/util/logos/payment-methods/twint/30/original.png", width = 65, height = 41),
                                      medium = PaymentMethodImage(url = "https://flowcdn.io/util/logos/payment-methods/twint/60/original.png", width = 100, height = 60),
                                      large = PaymentMethodImage(url = "https://flowcdn.io/util/logos/payment-methods/twint/120/original.png", width = 256, height = 256)
                                    ), regions = Seq("world"), capabilities = Some(Nil))
  val Unionpay: PaymentMethod = PaymentMethod(id = "unionpay", `type` = PaymentMethodType.Online, name = "UnionPay", images = PaymentMethodImages(
  ...
  val Vipps: PaymentMethod = PaymentMethod(id = "vipps", `type` = PaymentMethodType.Online, name = "Vipps", images = PaymentMethodImages(
                                      small = PaymentMethodImage(url = "https://flowcdn.io/util/logos/payment-methods/vipps/30/original.png", width = 40, height = 26),
                                      medium = PaymentMethodImage(url = "https://flowcdn.io/util/logos/payment-methods/vipps/60/original.png", width = 77, height = 50),
                                      large = PaymentMethodImage(url = "https://flowcdn.io/util/logos/payment-methods/vipps/120/original.png", width = 154, height = 100)
                                    ), regions = Seq("world"), capabilities = Some(Nil))
  val Visa: PaymentMethod = PaymentMethod(id = "visa", `type` = PaymentMethodType.Card, name = "VISA", images = PaymentMethodImages(
  ...
  val Wechatpay: PaymentMethod = PaymentMethod(id = "wechatpay", `type` = PaymentMethodType.Online, name = "WeChat Pay", images = PaymentMethodImages(
