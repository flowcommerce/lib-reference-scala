...
object Currencies {
  ...
  val Czk = Currency(iso42173 = "CZK", name = "Czech Koruna", numberDecimals = 2, defaultLocale = None, symbols = Some(CurrencySymbols(primary = "CZK", narrow = Some("Kč"))))
  ...
  val Etb = Currency(iso42173 = "ETB", name = "Ethiopian Birr", numberDecimals = 2, defaultLocale = None, symbols = Some(CurrencySymbols(primary = "ETB", narrow = None)))
  ...
  val Huf = Currency(iso42173 = "HUF", name = "Hungarian Forint", numberDecimals = 2, defaultLocale = Some("hu"), symbols = Some(CurrencySymbols(primary = "HUF", narrow = Some("Ft"))))
  ...
  val Mvr = Currency(iso42173 = "MVR", name = "Maldives Rufiyaa", numberDecimals = 2, defaultLocale = None, symbols = Some(CurrencySymbols(primary = "MVR", narrow = None)))
  val Mro = Currency(iso42173 = "MRO", name = "Mauritania Ouguiya", numberDecimals = 1, defaultLocale = Some("ar-MR"), symbols = Some(CurrencySymbols(primary = "MRO", narrow = None)))
  ...
  val Nad = Currency(iso42173 = "NAD", name = "Namibian Dollar", numberDecimals = 2, defaultLocale = None, symbols = Some(CurrencySymbols(primary = "NAD", narrow = Some("$"))))
  ...
  val Zar = Currency(iso42173 = "ZAR", name = "South African Rand", numberDecimals = 2, defaultLocale = Some("af-NA"), symbols = Some(CurrencySymbols(primary = "ZAR", narrow = Some("R"))))
  ...
  val Sek = Currency(iso42173 = "SEK", name = "Swedish Krone", numberDecimals = 2, defaultLocale = None, symbols = Some(CurrencySymbols(primary = "SEK", narrow = Some("kr"))))
  ...
  val Tnd = Currency(iso42173 = "TND", name = "Tunisian Dinar", numberDecimals = 3, defaultLocale = None, symbols = Some(CurrencySymbols(primary = "TND", narrow = None)))
  ...
  val Usd = Currency(iso42173 = "USD", name = "US Dollars", numberDecimals = 2, defaultLocale = Some("en-US"), symbols = Some(CurrencySymbols(primary = "$", narrow = Some("$"))))
